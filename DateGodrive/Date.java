...
public class Date {
    ...
    private JTextField loca, hour, minute, hour2, minute2;
    private JComboBox<String> day, month, day2, month2;
    private JButton ok;
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String Month2 = (String)month2.getSelectedItem(); 
                 ...
                 try (BufferedWriter writer = new BufferedWriter(new FileWriter(fileName,true))){
                  //สร้างบรรทัดข้อมูลในรูปแบบcsv
                  String csvLine = String.join(",",Loca,"Pic-up:"+Day+" "+Month+"/"+Hour+"."+Minute,"Return:"+Day2+" "+Month2+"/"+Hour2+"."+Minute2);
